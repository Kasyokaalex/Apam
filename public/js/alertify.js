  ...
  var dialog = (function () {
    ...
    function initialize(instance) {
      if (!instance.__internal) {
        ...
        instance.set(
          "modal",
          setup.options.modal === undefined
            ? alertify.defaults.modal
            : setup.options.modal
        );
        instance.set(
          "basic",
          setup.options.basic === undefined
            ? alertify.defaults.basic
            : setup.options.basic
        );
        instance.set(
          "frameless",
          setup.options.frameless === undefined
            ? alertify.defaults.frameless
            : setup.options.frameless
        );

        instance.set(
          "movable",
          setup.options.movable === undefined
            ? alertify.defaults.movable
            : setup.options.movable
        );
        instance.set(
          "moveBounded",
          setup.options.moveBounded === undefined
            ? alertify.defaults.moveBounded
            : setup.options.moveBounded
        );
        instance.set(
          "resizable",
          setup.options.resizable === undefined
            ? alertify.defaults.resizable
            : setup.options.resizable
        );
        instance.set(
          "autoReset",
          setup.options.autoReset === undefined
            ? alertify.defaults.autoReset
            : setup.options.autoReset
        );

        instance.set(
          "closable",
          setup.options.closable === undefined
            ? alertify.defaults.closable
            : setup.options.closable
        );
        instance.set(
          "closableByDimmer",
          setup.options.closableByDimmer === undefined
            ? alertify.defaults.closableByDimmer
            : setup.options.closableByDimmer
        );
        instance.set(
          "maximizable",
          setup.options.maximizable === undefined
            ? alertify.defaults.maximizable
            : setup.options.maximizable
        );
        instance.set(
          "startMaximized",
          setup.options.startMaximized === undefined
            ? alertify.defaults.startMaximized
            : setup.options.startMaximized
        );

        instance.set(
          "pinnable",
          setup.options.pinnable === undefined
            ? alertify.defaults.pinnable
            : setup.options.pinnable
        );
        instance.set(
          "pinned",
          setup.options.pinned === undefined
            ? alertify.defaults.pinned
            : setup.options.pinned
        );

        instance.set(
          "transition",
          setup.options.transition === undefined
            ? alertify.defaults.transition
            : setup.options.transition
        );

        instance.set(
          "padding",
          setup.options.padding === undefined
            ? alertify.defaults.padding
            : setup.options.padding
        );
        instance.set(
          "overflow",
          setup.options.overflow === undefined
            ? alertify.defaults.overflow
            : setup.options.overflow
        );
