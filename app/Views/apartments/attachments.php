...
<div class="modal-header">
    ...
    <h4 class="modal-title"><?=$this->lang->line("apartments_attachments"); ?></h4>
            ...
            <li>
                <label>
                    <input type="checkbox" 
                           class="select_file" 
                           value="<?= $attachment["id"]; ?>"
                           data-url="<?= getDomain(); ?>/uploads/apartment-<?= $apartment_info->apartment_id; ?>/<?= $attachment["filename"]; ?>"
...
<div class="modal-footer">
    <button type="button" class="btn btn-sm btn-default" data-dismiss="modal" id="btn-close"><?= $this->lang->line("common_close"); ?></button>
    <?php if ($select_type === "proof"): ?>
        <button id="btn-select-proof" class="btn btn-sm btn-primary" type="button"><?= $this->lang->line('common_select'); ?></button>
    <?php else: ?>
        <button id="btn-select-images" class="btn btn-sm btn-primary" type="button"><?= $this->lang->line('common_select'); ?></button>
    <?php endif; ?>
</div>
