...
class Plugins extends Controller implements iData_controller {
    ...
    function data()
    {
        ...
        foreach ($$controller_name->result() as $data)
        {
            ...
            //$action[] = anchor($controller_name . '/view/' . $data->$id, $this->lang->line('common_edit'), array('class' => 'modal_link btn btn-success', 'data-bs-toggle' => 'modal', 'data-target' => '#' . $controller_name . '_modal', "title" => $this->lang->line($controller_name . '_update')));

            if ($data->status_flag === 'Active')
            {
                $action[] = anchor($controller_name . '/manage/' . $data->$id, $this->lang->line($controller_name . '_manage'), array('class' => 'modal_link btn btn-success', 'data-bs-toggle' => 'modal', 'data-target' => '#' . $controller_name . '_modal', "title" => $this->lang->line($controller_name . '_manage')));
            }
            else
            {
